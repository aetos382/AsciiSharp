...
public sealed class AsgConverter : ISyntaxVisitor<AsgNode?>
{
    ...
    public AsgDocument Convert()
    {
        ...
        return (AsgDocument)document.Accept(this)!;
    }
    ...
    /// <see cref="Convert"/> で <see cref="ConvertHeader"/> を通じて処理する。
    /// </remarks>
    ...
    /// <see cref="Convert"/> で <see cref="ConvertBlocks"/> を通じて処理する。
    /// </remarks>
    ...
    /// <see cref="ISyntaxVisitor{TResult}.VisitSection"/> で <see cref="ConvertTitleInlines"/> を通じて処理する。
    /// </remarks>
